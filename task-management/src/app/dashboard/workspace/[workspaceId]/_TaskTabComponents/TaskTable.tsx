...
const TaskTable = ({
  ...
  const status = [
    { title: "pending", style: "bg-tag-neutral text-atg-neutral-foreground" },
                          ...
                          <CommandGroup>
                            {priorities.map((priority) => (
                              <CommandItem
                                ...
                                onSelect={() =>
                                  updatePriority(todo.id, priority.value)
                                }
                                className="flex items-center gap-2 cursor-pointer"
                              >
                                <Badge className={priority.style}>
                                  {priority.label}
                                </Badge>
